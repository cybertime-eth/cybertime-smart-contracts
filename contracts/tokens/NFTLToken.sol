...
contract NFTLToken is ERC20 {
    ...
    // Modifiers
    modifier onlyOwner() {
        require(isOwner(), "NFTL: caller is not the owner");
        _;
    }

    constructor(address _owner) ERC20("NFT Fantasy League", "NFTL") {
        // set owner
        owner = _owner;
    }
    ...
    function mint(address _to, uint256 _amt) external {
        require(minters[msg.sender] == true, "NFTL: Invalid Minter");
        _mint(_to, _amt);
    }
